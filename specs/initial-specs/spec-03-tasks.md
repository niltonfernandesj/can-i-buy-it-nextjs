> **Arquivo histórico — não editar.** Snapshot congelado das tasks ao final da sprint 1 (M1–M7), antes do início da sprint 2. A versão viva e atualizada fica em `specs/spec-03-tasks.md`.
