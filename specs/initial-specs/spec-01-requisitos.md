> **Arquivo histórico — não editar.** Snapshot congelado dos requisitos ao final da sprint 1 (M1–M7), antes do início da sprint 2. A versão viva e atualizada fica em `specs/spec-01-requisitos.md`.
