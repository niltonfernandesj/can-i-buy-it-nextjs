 ...
 * (Design §13.3). Serve tanto a Visão geral (um mês) quanto a Projeção
 * (doze meses) — não há duas implementações da regra.
 */
export function comporMes({ mesReferencia, anoReferencia, transacoes, valoresPadrao, cartoes, hoje }) {
