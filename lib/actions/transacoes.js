...
/**
 * Resolve o categoriaId recebido do formulário e devolve os campos de
 * gravação — os DOIS, enquanto a coluna enum existir (Design §18.2).
 *
...
async function resolverCategoria(categoriaId, idAtual) {
  ...
  return {
    campos: {
      ...
      categoria: enumLegadoDaCategoria(categoria.nome),
    },
  };
}
