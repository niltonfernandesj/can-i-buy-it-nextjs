...
// `idAtual` permite que uma categoria já inativa continue valendo numa
// edição (Design §18.3).
...
async function validarValorPadrao({ descricao, valor, tipo, meio, categoriaId }, categoriaIdAtual) {
  ...
  // Receita padrão não tem categoria.
  return {
    valores: { descricao: descricao.trim(), valor: valorNum, tipo, meio: null, categoriaId: null },
  };
}
